...
export default function AllMaterials() {
  ...
  const isLandscape = useMediaQuery({ minWidth: 844, maxWidth: 1023 });
  ...
  return (
    <div className="container w-75">
      {isMobile || isLandscape ? <div>
        <div className="searchBar">
          <div className={style.searchLine + " input-group mb-4 w-100 mt-3"}>
        ...
        <div className={style.filterBar + " "}>
          <div className={style.filterSymbol + " row text-center"}>
          ...
          <div className="row">
            ...
            <Button variant="contained" className={style.editBtn + " mb-4"}>
            ...
            >
              <div className="col-12">
                <div className="row p-3">
                  <div className="col-12 mb-1 d-flex justify-content-center align-items-center position-relative">
                    <div className={style.editImg}>
                      {material.uploader.Img ? (
                        <img src={material.uploader.Img} alt="user img" className="w-100" />
                      ) : (
                        <i className="fa-solid fa-user bg-light p-3 fs-5"></i>
                      )}
                    </div>
                    <i className="fa-solid fa-ellipsis-vertical text-white position-absolute end-0 me-3"></i>
                  </div>
                ...
                <div className="col-md-4">
                  <div className="row p-3">
                    <div className="col-md-3">
                      <div className={style.editImg}>
                        {material.uploader.Img ? material.uploader.Img : <i className="fa-solid fa-user bg-light p-3 fs-5"></i>}
                      </div>
                    </div>
