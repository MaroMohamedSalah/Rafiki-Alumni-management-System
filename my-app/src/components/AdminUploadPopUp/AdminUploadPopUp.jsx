...
export default function AdminUploadPopUp({ isOpen, onClose, userId, fileUrl, title }) {
            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description" className={style.DialogContent + " mt-2"}>
                        ...
                        <div className='col-md-12'>
                            <a href={fileUrl} className='text-decoration-none'><button className='btn d-block m-auto mt-1'>Go To File</button></a>
                        </div>
                    ...
                    <div className={style.bottomBtns}>
                        ...
                        <Button variant="contained" className={style.submitBtn} onClick={openToast}>Accept</Button>
                    </div>
                </DialogContent>
                <DialogActions>
                </DialogActions>
