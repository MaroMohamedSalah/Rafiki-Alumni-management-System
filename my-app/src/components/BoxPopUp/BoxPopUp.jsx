            ...
            >
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description" className={style.DialogContent}>
                        ...
                        <div class="mb-3">
                            <textarea class={style.editTextArea + " form-control"} id="exampleFormControlTextarea1" rows="5" placeholder='Write Your Message.'></textarea>
                        </div>
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
                    <div className={style.bottomBtns}>
                        ...
                        <Button variant="contained" color={btnColor} >Submit</Button>
                    </div>
